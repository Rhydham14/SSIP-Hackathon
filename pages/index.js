    ...
    <>
      ...
      <div className="flex flex-col w-full justify-start items-center h-screen">
        ...
        >
          ...
          <button
            className="bg-[#43c0f5] z-10 text-lg transition-all w-[20%] text-[#141c28] font-semibold py-3 px-6 rounded-xl hover:scale-105"
            onClick={() => {
      ...
      >
        ...
        <div className="tracking-[1.75rem] uppercase text-2xl text-white text-ceter font-thin mb-28">
          <span>{text}</span>
    ...
    <>
      ...
      <div className="flex flex-col w-full justify-start items-center h-screen">
        ...
        <div className="flex flex-col items-center justify-center h-screen w-full bg-[#141c28] text-white">
          ...
          <div className="text-6xl font-semibold mb-10">Fast For Everyone</div>
          <motion.button
      ...
      <div
        ...
        ref={ref}
      >
        <div className="w-[90%] h-96 flex justify-around items-start rounded-2xl shadow-all">
          <div className="flex flex-col">
            <div className="w-56 h-24 bg-black m-8"></div>
            <div className="w-56 h-24 bg-black m-8"></div>
            <div className="w-56 h-24 bg-black m-8"></div>
          </div>
          <div className="w-56 h-24 bg-black"></div>
        </div>
      </div>
    </>
  );
